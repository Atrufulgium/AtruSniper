execute as @s at @s run particle minecraft:dust 0.1 0.1 0.9 4 ~ ~ ~ 0 0 0 1 1 force
...
execute as @s[scores={movex=1..999}] run function atrufulgium_sniper:graphics/movestraightblue
execute as @s[scores={movex=0,movey=1..999}] run function atrufulgium_sniper:graphics/movestraightblue
execute as @s[scores={movex=0,movey=0,movez=1..999}] run function atrufulgium_sniper:graphics/movestraightblue