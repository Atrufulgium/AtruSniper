...
execute if score @s posx >= @s selectionbox_x2 at @s run function atrufulgium_sniper:tools/mirrory/_ltsc_if1
execute if score @s posz < @s selectionbox_z2 at @s run function atrufulgium_sniper:tools/mirrory/loopthroughselection