...
execute as @s at @s run function atrufulgium_sniper:checkifinellipsoid
execute as @s at @s if blocks ~ ~ ~ ~ ~ ~ 1 0 0 all if score 0 math_output matches 0..100 run clone 0 0 0 0 0 0 ~ ~ ~ replace force
...
execute if score @s posz < @e[scores={caller=1},limit=1] selectionbox_z2 at @s run function atrufulgium_sniper:tools/ellipsoidreplace/loopthroughselection